 ...
 * with a RuName passed as argument is required for sessionID request
 * RuName to be added in configuration.php
 * to make getsession request
 * 
 * For more information about creating a request object, see:
 * http://devbay.net/sdk/guides/getting-started/#request-object
 */

$request = new Types\GetSessionIDRequestType(array('RuName'=>$config['sandbox']['RuName']));
...
/**
 * Send the request to the getSessionID service operation.
 *
